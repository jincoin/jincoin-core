...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 23099
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19776
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 33099
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 23099
	%{_sbindir}/semanage port -d -p tcp 19776
	%{_sbindir}/semanage port -d -p tcp 33099
	for selinuxvariant in %{selinux_variants}; do
