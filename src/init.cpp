 ...
 * between jincoind, and jincoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/JinCoin/Jincoin-Core>";
    const std::string URL_WEBSITE = "<https://jin-coin.com>";
...
/** Sanity checks
 *  Ensure that Jincoin is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Jincoin process is using the data directory.
